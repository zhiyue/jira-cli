...
pub fn run<W: Write>(out: &mut W, cfg: &JiraConfig, client: &HttpClient, cli: &Cli) -> Result<()> {
    match &cli.cmd {
        ...
        Command::Ping => commands::meta::ping(out, cfg, client, &cli.global),
        Command::Whoami => commands::meta::whoami(out, cfg, client, &cli.global),
        ...
        Command::Search(a) => commands::search::run(out, cfg, client, &cli.global, a),
        Command::Project(sub) => commands::project::dispatch(out, cfg, client, &cli.global, sub),
        Command::User(sub) => commands::user::dispatch(out, cfg, client, &cli.global, sub),
        Command::Board(sub) => commands::board::dispatch(out, cfg, client, &cli.global, sub),
        Command::Sprint(sub) => commands::sprint::dispatch(out, cfg, client, &cli.global, sub),
        Command::Epic(sub) => commands::epic::dispatch(out, cfg, client, &cli.global, sub),
